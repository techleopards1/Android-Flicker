...
private const val DETAIL_IMAGE_ASPECT_RATIO = 16f / 9f
    ...
    LazyColumn(modifier = modifier.fillMaxSize()) {
        item {
            AppAsyncImage(
                ...
                modifier = Modifier.fillMaxWidth().aspectRatio(DETAIL_IMAGE_ASPECT_RATIO),
            )
        }
        item {
...
private fun DetailEmptyPreview() {
    FlickerGalleryTheme {
        DetailContent(
            uiState = DetailUiState(isEmpty = true),
            onEvent = {},
            onNavigateBack = {},
        )
    }
